...
export default function CertificateBanner() {
  return (
    <>
      <div className="w-full mt-20 min-h-[50vh]  relative bg-purble">
        <div className="w-[80%] max-md:w-full max-md:p-3 h-full ml-auto ">
          <div className="content max-lg:h-[50vh] max-lg:flex max-lg:items-center justify-center z-[30] relative ">
            <div className="">
              ...
              <button className="btn block z-[50] relative overflow-hidden group/btn whitespace-nowrap px-16 py-4 max-md:w-full mt-6 text-center bg-black text-white rounded-full ">
                <p className="z-[3] relative block">Get Start Now</p>
        ...
        <Img
          src="/assets/cta.webp"
          className="w-[700px] max-md:w-[400px] mx-auto max-lg:w-[500px] mask-bottom absolute max-md:relative bottom-0 z-[5] right-0 object-contain"
        />
        {/* <div className="w-[45%] h-full rounded-l-full max-md:w-[1200px]  mask-bottom bg-black/20 absolute top-0 right-0"></div> */}
        <div className="flex items-center justify-between flex-col h-full  absolute left-0 -top-12">
          <motion.div
            initial={{ scale: "100%" }}
