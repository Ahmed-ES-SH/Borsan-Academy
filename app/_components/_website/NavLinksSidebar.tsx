...
export default function NavLinksSidebar() {
  const { showNavLinksDrop, setShowNavLinksDrop } = UseVariables();
            ...
            >
              ...
              <div className="logo flex items-center gap-1 pb-2 border-b border-gray-300">
                <div className="w-16 h-16 bg-white rounded-full">
                  <Img src="/website/logo.png" className="w-16" />
                </div>
              ...
              <div className="mt-12 flex flex-col gap-4">
                <div className="flex items-center gap-4 ">
                  <FiPhone className="size-12 text-secondery-green" />
                ...
                <div className="flex items-center gap-4 ">
                  <TfiEmail className="size-12 text-secondery-green" />
                  <div className="flex flex-col gap-1">
              ...
              <div className="btns flex flex-col w-full items-center gap-4 mt-6 ">
                <button className="px-8 py-3 w-full max-lg:px-3  rounded-sm bg-primary   text-white hover:bg-secondery-green   duration-200 flex items-center gap-2">
                  <p>Login</p>
                  <CiLogin />
                </button>
                <button className="px-8 py-3 w-full text-left max-lg:px-3  rounded-sm bg-fourth_dash   text-white hover:bg-secondery-green   duration-200">
                  Register
                </button>
              </div>
              <div className="absolute bottom-1 left-0 w-full grid grid-cols-4">
                {socialIcons.map((item, index) => (
                  <div
                    key={index}
                    className="border border-gray-50 py-2 cursor-pointer hover:text-secondery-green text-white duration-300  flex items-center justify-center"
                  >
                    {item.icon}
                  </div>
                ))}
