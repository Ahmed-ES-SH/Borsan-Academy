      ...
      {showNavLinksDrop && (
        ...
        >
          <motion.div
            ...
            className="w-1/3 overflow-hidden max-md:w-3/4 h-screen overflow-y-auto pt-8 flex flex-col items-start max-[20rem]:w-[200px] bg-thired_dash fixed top-0 "
          >
            ...
            <div className="w-full  h-fit mt-auto pt-3 mb-1 grid grid-cols-4">
