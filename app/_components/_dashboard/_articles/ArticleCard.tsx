...
export default function ArticleCard({ Article, direct, locale = "en" }: props) {
            ...
            <div className="flex flex-col justify-between items-start w-full h-full pb-3">
              <div className="flex flex-col gap-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <h1>
                    {locale == "ar"
                      ? Article.title_ar.length > 30
                        ? Article.title_ar.slice(0, 30) + "..."
                        : Article.title_ar
