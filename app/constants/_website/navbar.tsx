...
export const linksNav = [
  {
    ...
    title_ar: "الرئيسية",
    to: "/",
    icon: <BiHome className="size-6 max-md:size-4 text-secondery-green" />,
  },
  {
    title_en: "Courses",
    title_ar: "الدورات",
    to: "/courses",
    icon: <BiBook className="size-6 max-md:size-4 text-secondery-green" />,
  },
  ...
  },
  {
    ...
    title_ar: "المدونة",
    to: "/blog",
    icon: <BiNews className="size-6 max-md:size-4 text-secondery-green" />,
  },
